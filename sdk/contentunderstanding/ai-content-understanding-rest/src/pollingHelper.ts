...
export async function getLongRunningPoller<
  TResult extends ContentAnalyzersAnalyzeLogicalResponse | ContentAnalyzersAnalyzeDefaultResponse,
>(
  client: Client,
  initialResponse: ContentAnalyzersAnalyze202Response | ContentAnalyzersAnalyzeDefaultResponse,
  options?: CreateHttpPollerOptions<TResult, OperationState<TResult>>,
): Promise<SimplePollerLike<OperationState<TResult>, TResult>>;
export async function getLongRunningPoller<
  TResult extends
