...
async function main() {
  ...
  try {
    ...
    try {
      retrievedAnalyzer = await client.contentAnalyzers.get(analyzerId);
    ...
    if (retrievedAnalyzer) {
      ...
      if (retrievedAnalyzer.fieldSchema) {
        ...
        console.log(
          `    Description: ${retrievedAnalyzer.fieldSchema.description}`,
        );
        console.log(
        ...
        if (retrievedAnalyzer.fieldSchema.fields) {
          for (const [fieldName, fieldDef] of Object.entries(
            ...
            console.log(`      - ${fieldName}: ${fieldDef.type} (${fieldDef.method})`);
          }
        }
      }
