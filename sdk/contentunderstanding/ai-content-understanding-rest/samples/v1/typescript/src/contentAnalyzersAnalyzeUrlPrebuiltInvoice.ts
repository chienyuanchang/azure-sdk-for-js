 ...
 *
 * Run:
 *   npx ts-node contentAnalyzersAnalyzeUrlPrebuiltInvoice.ts
 */
...
import { saveJsonToFile, getFieldValue } from "./sampleHelper.ts";
 ...
 */
const analyzeInvoice = async (client: any): Promise<void> => {
  const fileUrl =
