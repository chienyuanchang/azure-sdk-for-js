...
/**
 * @summary Get result files (like keyframe images) from a video analysis operation.
 *
...
async function main() {
  ...
  try {
    ...
    // Prime the poller so that the initial request is sent and state is populated
